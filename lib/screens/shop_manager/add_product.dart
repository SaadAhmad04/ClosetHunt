...
//   final variantCountController = TextEditingController();
//   final variantPriceController = TextEditingController();
//   final orderLimitController = TextEditingController();
//   File? productImage;
...
//                       ),
//                       TextFormField(
//                         controller: variantCountController,
//                         inputFormatters: [
...
//                           border: OutlineInputBorder(
//                               borderRadius: BorderRadius.circular(20)),
//                           label: Text('Variant Count'),
//                         ),
//                         validator: (val) {
//                           if (val!.isEmpty) {
//                             return 'Enter variant count';
//                           } else {
//                             return null;
//                           }
//                         },
...
//                           border: OutlineInputBorder(
//                               borderRadius: BorderRadius.circular(20)),
//                           label: Text('OrderLimit'),
//                         ),
//                         validator: (val) {
//                           if (val!.isEmpty) {
//                             return 'Enter order limit';
//                           } else {
//                             return null;
//                           }
//                         },
...
//                   String imageUrl =
//                       await Auth.uploadProductImage(productImage!);
//                   print('image ${imageUrl}');
//                   Auth.productRef.doc(productIdController.text).set({
...
//                     'categoryPath': dropDownValue.toString(),
...
//                     'size': dropDownSize == "Select size" ? "" : dropDownSize,
//                     'deliveryTime': deliveryTimeController.text.toString(),
//                     'variantCount': variantCountController.text,
//                     'variantPriceString': variantPriceController.text,
//                     'orderLimit':
//                     int.parse(orderLimitController.text.toString())
//                   });
//                   Auth.shopManagerRef
...
//                 }
//                 else{
//                   Utilities().showMessage('Upload product image');
//                 }
//               }
//               else{
//                 Utilities().showMessage('Select atleast one category');
//               }
//             }
//           },
//           child: Container(
